...
from miet_clifford.simulation import parameter_sweep, load_results
...
def main():
    parser = argparse.ArgumentParser(description="MIET production sweep")
    parser.add_argument(
        "--seed",
        type=int,
        default=None,
    ...
    results = parameter_sweep(
        L_VALUES, P_VALUES, N_SAMPLES, save_path=SAVE_PATH, verbose=True, seed=args.seed
    )
