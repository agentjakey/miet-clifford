...
def test_parameter_sweep_reproducible(tmp_path):
    ...
    parameter_sweep(L_vals, p_vals, n_samples=4, save_path=p, verbose=False, seed=123)
    parameter_sweep(L_vals, p_vals, n_samples=4, save_path=q, verbose=False, seed=123)
...
def test_metadata_file_created(tmp_path):
    ...
    parameter_sweep(
        [4], np.linspace(0.0, 0.5, 3), n_samples=2, save_path=npz, verbose=False, seed=0
    )
