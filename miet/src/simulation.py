...
def parameter_sweep(L_values, p_values, n_samples,
                    ...
                    save_path=None, verbose=True, n_workers=1, seed=None):
    ...
    for i, L in L_iter:
        ...
        p_iter = (tqdm(p_range, desc=f"  L={L}", leave=False)
                  if verbose else p_range)
